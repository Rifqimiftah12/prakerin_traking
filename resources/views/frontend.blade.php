            ...
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                <div class="card bg-danger img-card box-primary-shadow">
                    <div class="card-body">
                        ...
                        <div class="ml-auto"> <img src="{{asset('assets/assets/img/sad-u6e.png')}}" width="50" height="50"> </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                <div class="card bg-danger img-card box-primary-shadow">
                    <div class="card-body">
                        ...
                        <div class="ml-auto"> <img src="{{asset('assets/assets/img/bahagia.png')}}" width="50" height="50"> </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                <div class="card bg-danger img-card box-primary-shadow">
                    <div class="card-body">
                        ...
                        <div class="ml-auto"> <img src="{{asset('assets/assets/img/sedih.png')}}" width="50" height="50"> </div>
                    </div>
                </div>
            </div>
        </div>
