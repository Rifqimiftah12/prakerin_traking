            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    <div class="card-header">
                        <center><b>{{ __('Detail Data Kasus Local') }}</b></center>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jumlah_positif" class="form-control" id="exampleInputPassword1"
                                value="{{ $kasus2->jumlah_positif }}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Jumlah Meninggal</label>
                            <input type="text" name="jumlah_meninggal" class="form-control" id="exampleInputPassword1"
                                value="{{ $kasus2->jumlah_meninggal }}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Jumlah Positif</label>
                            <input type="text" name="jumlah_sembuh" class="form-control" id="exampleInputPassword1"
