                    ...
                    @foreach($kasus as $data)
                      <tr>
                        ...
                        <form action="{{route('kasus.destroy', $data->id)}}" method="post">
                                @csrf
                                @method('DELETE')
                                <td><a class="btn btn-primary btn-sm" href="{{route('kasus.show', $data->id)}}"><i class="fa fa-eye"></i></a>|
                                <a class="btn btn-warning btn-sm" href="{{route('kasus.edit', $data->id)}}"> <i class="fa fa-edit"></i> </a>|
