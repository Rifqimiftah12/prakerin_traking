...
class NegaraController extends Controller{
    ...
    {
        $negara = Negara::all();
        return view('negara.create' ,compact('negara'));
    }
    public function store(Request $request)
    {
        ...
        $negara->save();
        return redirect()->route('negara.index')->with(['message' => 'Data negara Berhasil disimpan']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $negara->nama_negara = $request->nama_negara;
        $negara->save();
        return redirect()->route('negara.index')->with(['message' => 'Data negara Berhasil diedit']);
    }
